...
var UserWhere = struct {
	...
	IsDeleted: whereHelpernull_Bool{field: "\"users\".\"is_deleted\""},
	IsAdmin:   whereHelpernull_Bool{field: "\"users\".\"is_admin\""},
...
var (
	userAllColumns            = []string{"id", "created_at", "updated_at", "is_active", "is_deleted", "is_admin", "username", "email", "password", "first_name", "last_name"}
	userColumnsWithoutDefault = []string{"username", "email", "password", "first_name", "last_name"}
	userColumnsWithDefault    = []string{"id", "created_at", "updated_at", "is_active", "is_deleted", "is_admin"}
